...
# the documents converge — and, unless `SELVAGE_E2E_RECONNECT=0`, that a guest whose socket is
# cut mid-session reconnects and re-converges.
#
...
#   SELVAGE_E2E_RECONNECT=0 scripts/e2e/run-two-instance.sh   # convergence only
