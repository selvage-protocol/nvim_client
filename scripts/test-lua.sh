...
# stubbed companion (`test/lua/session.lua`), what the commands themselves decide
# (`test/lua/commands.lua`), and what stopping the process does to it (`test/lua/leave.lua`,
# against a real job).
#
#   scripts/test-lua.sh
#
